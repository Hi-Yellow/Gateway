...
/* 			document.getElementById("btn1").click(); */
		...
		function setRegister(){
			...
			if(userName.length == 0){
				...
				$.post("saUser/saRegister.action",{userName:userName,userPsw:userPsw1,code:code},function(response){finish(response);});
			}else document.getElementById("p1").innerHTML = "·注册失败，请重新输入！";
		}
		function finish(result){
			if(result == 0){
				...
				document.getElementById("p1").innerHTML = "·该手机号已注册！";
			}
		}
	</script>
	</head>
        ...
        <div class="row">
			...
			<div class="col-sm-5">
				...
				<h2 align="center" >用户注册</h2>
                    <input id="RuserName" type="text" name="RuserName" class="form-control userName" placeholder="手机号" required="true" maxlength="11" 
					onkeyup="checkUserName(this.value)" onchange="checkUserName(this.value)" style="color: black"/>
                    <input id="RpassWord" type="password" name="RpassWord" class="form-control pword m-b" placeholder="密码"  required="true" maxlength="20" 
					...
					<button id="btn2" name="btn2" onClick="setRegister()" type="button" class="btn btn-success btn-block">注册</button>
					<hr>
					<p><a href="login.jsp">已有账号，直接登录</a></p>					
                </form>
             </div>
        </div>
