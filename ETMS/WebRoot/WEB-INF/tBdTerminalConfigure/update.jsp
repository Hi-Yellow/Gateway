...
<body class="mybody">
	...
	<table style="width: 371px; ">
		...
		<tr class="myfitem3">
			...
			<td><input type="text" name="dataSendCount" /></td>
		</tr>
		<tr class="myfitem3">
	...
	<script type="text/javascript">
		...
		var row = parent.$('#dg').datagrid("getSelected");
			row.tBdTerminalConfigurePrivilegeStart = format(row.tBdTerminalConfigurePrivilegeStart);
		...
		$("#btn").click(function() {
				...
				if ($("#ff").form("validate")) {
					$('#ff').form('submit', {
						url : 'tBdTerminalConfigure/update.action',
						onSubmit : function() {
							return true;
						},
